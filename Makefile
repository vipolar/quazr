...
clone-repos:
	@echo "➡️  Reading GH_TOKEN from .env..."
...
prune-all: down
	@echo "🛑  Aggressive prune will remove unused VOLUMES (data loss risk)."
